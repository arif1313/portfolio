            ...
            <div className="bg-[#FEFAF3] h-full w-4/5 flex absolute items-center top-0 justify-start clip">
                ...
                <div className="p-5">
                    ...
                    <h1 className="text-2xl lg:text-5xl font-bold mt-5">
                        <span className="text-[#28E98C]">MD Arif Hossen</span>
                    </h1>
                    ...
                    <div className=" flex gap-5 mt-5 ">
                        <div>
                        <a href={cv} download='Md Arif resume' className="btn bg-[#28E98C] text-white border-none font-bold py-2 px-4 rounded-md hover:bg-[#D97706]">
                        Hire me 
                    </a>
                        </div>
                   <div>
